                ...
                <div class="pricingTable">
                    <div class="pricingTable-header">
                        ...
                        <span class="price-value">
                            <span class="month">ID Pelanggan : <?= $pelanggan['id_pelanggan'] ?></span>
                        </span>
                    </div>
        ...
        ?>
            <tr>
              ...
              <form action="m_hitung_sub_total.php" method="post">
                ...
                <td>
                  <input type="text" name="stok_barang" value="<?= $stok_barang ?>" readonly  class="form-control" aria-describedby="basic-addon2"></td>
                </td>
              </form>
